...
namespace Drupal\mymodule\Entity\Controller;
...
class ContactListBuilder extends EntityListBuilder {
  ...
  public function render() {
    $build['description'] = [
      '#markup' => $this->t('Content Entity implements a Contacts model. These contacts are fieldable entities. You can manage the fields on the <a href="@adminlink">Contacts admin page</a>.', [
        '@adminlink' => $this->urlGenerator->generateFromRoute('mymodule.contact_settings'),
      ]),
    ];
